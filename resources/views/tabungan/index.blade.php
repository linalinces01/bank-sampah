...
<body>
    ...
    <div class="form-container">
        <form id="dataForm" method="POST" action="{{ route('tabungan.store') }}">
            ...
            <input type="number" id="phone" name="nomor_telepon" required>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="{{ route('tabungan.edit', $item->id) }}" class="btn btn-edit" title="Edit">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                    
                        <form action="{{ route('tabungan.destroy', $item->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
